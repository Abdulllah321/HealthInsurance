...
namespace HealthInsurance.Controllers
{
    ...
    public class PolicyRequestController : Controller
    {
        ...
        public PolicyRequestController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString, int pageNumber = 1)
        {
            ...
            var viewModel = new PolicyRequestIndexViewModel
            {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("RequestId,RequestDate,EmpNo,PolicyId,PolicyAmount,EMI,CompanyId,Status")] PolicyRequestDetailsUpdateDto policyRequestDetails)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    existingPolicyRequest.EmpNo = policyRequestDetails.EmpNo;
    ...
    public class PolicyRequestIndexViewModel
    {
